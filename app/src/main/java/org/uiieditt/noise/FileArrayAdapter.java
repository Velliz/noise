...
public class FileArrayAdapter extends ArrayAdapter<Option2> {

	private Context c;
	private int id;
	private List<Option2> items;

	public FileArrayAdapter(Context context, int textViewResourceId,
			List<Option2> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final Option2 o = items.get(position);
		if (o != null) {
